        ...
        const html = `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold mb-3">Pilih Warna yang Mewakili Mood Anda</h3>
                        ...
                        <div class="text-center text-gray-500 text-sm mt-2">
                            Pilih warna yang mewakili mood Anda saat ini
                        </div>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md" id="face-tracker-container">
